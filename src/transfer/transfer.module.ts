...
import { CompanyRepositoryMongoAdapter } from 'src/company/infrastructure/repositories/company.repository';
import { CompanySchema } from 'src/company/infrastructure/schemas/company.schema';
